...
$sql = "
   ...
   FROM gratuity_tbl 
   INNER JOIN department 
   ON department.officecode = gratuity_tbl.officecode AND isaudited=1
     ";
        ...
        $subarray[] = 
                          '
                             ...
                             href="gratuity-print-jo?payroll_id='.$payroll_id.'">
                              ...
                              View</span></a><a data-toggle="tooltip" data-placement="top" title=" " target="_blank" class="text-white" 
                             href="grat-download-txt?payroll_id='.$payroll_id.'">
        ...
        $subarray[] = 
                          '
                             ...
                             href="gratuity-print-jo?payroll_id='.$payroll_id.'">
                               <span class="btn btn-sm btn-info">
                              View</span></a>
                              <a data-toggle="tooltip" data-placement="top" title=" " target="_blank" class="text-white" 
                             href="grat-download-txt?payroll_id='.$payroll_id.'">
                               <span class="btn btn-sm btn-success">
                              Download</span></a>
                        ';
