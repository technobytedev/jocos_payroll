...
if(isset($_POST['add_one_emp']) && $_POST['employee'] != '') {
   ...
   $date_created = $_POST['date_created'];
    ...
    if(count($_POST['employee'])==count(array_count_values($_POST['employee']))){
           ...
           $query = mysqli_query($db, "SELECT DISTINCT type FROM payroll_jo_tbl WHERE payroll_id='$payroll_id' ");
        ...
        for($i = 0; $i < sizeof($_POST['employee']); $i++) {
            ...
            if($_POST['employee'][$i] != '') {
                ...
                $query = mysqli_query($db, "INSERT INTO payroll_jo_tbl(payroll_id,name_id,type,position_code,salary_rate,officecode,days,date_from,date_to,date_created) 
                                            VALUES('$payroll_id','$emp_id[0]','$type','$positioncode',
                                            '$salary','$officecode','$days','$from','$to','$date_created')");
            }
...
document.location="view-payroll-jo?delete='.$id.'&payroll_id='.$payroll_id.'";
   ...
   $query = mysqli_query($db, "DELETE FROM payroll_jo_tbl WHERE name_id='$id' ");
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog"
           ...
           <input type="text"class="form-control" id="emp_name" readonly=""><br>
            ...
            <input type="number" min=0 max=12 class="form-control" name="days" id="days">
