...
if(isset($_GET['payroll_id'])) {
    ...
    $query = mysqli_query($db, "SELECT gratuity_tbl.*, employment_info.*, position.* 
                                ...
                                WHERE payroll_id = '$p_id' AND atmno!=0 AND claimed='yes' ORDER BY surname");
    $num = 0;
    $gross = 0;
    $net = 0;
    $total_tax = 0;
...
?>
  <tr>
    ...
    <td class="last-td"><?php echo number_format((float)$total_tax, 2, '.', ',');  ?></td>
    <td class="last-td"><?php echo number_format((float)$net, 2, '.', ',');  ?></td>
    <td class="last-td"></td>
  </tr>
  ...
  <tr >
    ...
    Authorized Approving Officer<br><p><br><br><br><br><br><br></td>
   ...
   <p style="text-align:center;">___________________________________<br>
        Name & Signature of Disbursing Officer</p><br><br><br><br><br><br><br><br><br>
         <p style="text-align: right;; margin-bottom: -10px;"><?php echo "Date Printed: ".date('M d, Y'); ?></p><br><br><br>
    </td>
  </tr>
