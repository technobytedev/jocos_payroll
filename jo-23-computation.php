...
<body onload="window.print()">
 ...
 include('db.php');
    ...
    //                               AND isactive='yes' LIMIT 10 ");
       ...
       $query = mysqli_query($db, "SELECT DISTINCT officecode FROM employment_info                     
                                    WHERE employmenttype='JO'  AND taxcode='25com'
                                  AND isactive='yes' ");
      $num = 0;
      $total = 0;
      $max_days = 26;
...
<?php
   $query = mysqli_query($db, "SELECT * FROM employment_info
                                    WHERE employmenttype='JO'  AND taxcode='25com'
                                     AND isactive='yes' AND officecode='$officecode'  ORDER BY surname ");
    $num = 0;
     $total_per_office = 0;
