...
<body onload="window.print()">
      ...
      table,td, th {
       ...
       th{
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-2">
            <p class="head-left">CHARGE TO: <?php echo $charge; ?></p>
          ...
          <?php 
            ...
            <p class="head-right">MODE OF PAYMENT:  <?php echo $mode_of_payment; ?></p>
  ...
  <tr>
    ...
    <th  rowspan="2"  style="width:5%">Semimonthly Rate</th>
...
if(isset($_GET['payroll_id'])) {
 include('db.php');
    ...
    while($row = mysqli_fetch_array($query)) {
      ...
      // $query1 = mysqli_query($db, "UPDATE payroll_tbl SET payroll_id='CS20220201160232'
      //  WHERE name_id='$emp_no' AND payroll_id='CS20220201160231' ");
