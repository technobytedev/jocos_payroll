...
if(isset($_POST['audit_1'])) {
   ...
   $id = $_POST['payroll_id'];
  $query = mysqli_query($db, "UPDATE payroll_jo_tbl SET isaudited=1 WHERE payroll_id='$id' ");
  ...
  if(isset($_POST['audit_0'])) {
   ...
   $id = $_POST['payroll_id'];
  $query = mysqli_query($db, "UPDATE payroll_jo_tbl SET isaudited=0 WHERE payroll_id='$id' ");
...
if(isset($_POST['release_1'])) {
   ...
   $id = $_POST['payroll_id'];
  $query = mysqli_query($db, "UPDATE payroll_jo_tbl SET isreleased=1 WHERE payroll_id='$id' ");
// echo '<script>alert("'.$id.'")</script>';
  ...
  if(isset($_POST['release_0'])) {
   ...
   $id = $_POST['payroll_id'];
  $query = mysqli_query($db, "UPDATE payroll_jo_tbl SET isreleased=0 WHERE payroll_id='$id' ");
...
if(isset($_GET['delete_payroll'])) {
   ...
   $query = mysqli_query($db, "UPDATE payroll_jo_tbl SET isdeleted=1 WHERE payroll_id='$id' ");
...
<section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <h5 class="text-center">JO Payroll Salary Records</h5>
...
<script>
  ...
  var is_r = button.data('is_released') 
   ...
   modal.find('.modal-body #option_is_released').val(is_r)
        ...
        'lengthMenu': [[7, 25, 50, -1], [7, 25, 50, "All"]],
        'ajax':{
          'url':'load-treasurer-payroll-records-jo.php',
          'type':'post',
        },
        'fnCreatedRow':function(nRow,aData,iDataIndex)
        {
      ...
      $('#acc').DataTable({
        ...
        'lengthMenu': [[7, 25, 50, -1], [7, 25, 50, "All"]],
        'ajax':{
          'url':'load-acc-payroll-records-jo.php',
          'type':'post',
        },
        'fnCreatedRow':function(nRow,aData,iDataIndex)
        {
