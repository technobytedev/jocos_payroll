...
//                 ";
$id = $_POST['id'];
$sql = "SELECT * FROM employment_info WHERE employeeno='20201573'
                ";
...
if(isset($_POST['search']['value']))
{
  ...
  $sql .= " AND employeeno like '%".$search_value."%' ";
...
if(isset($_POST['order']))
{
  ...
  $sql .= "AND employeeno='$id' ORDER BY '".$column."' ".$order;
}
else
{
  $sql .="AND employeeno='$id' ORDER BY id DESC";
}
...
$subarray[] = '   <button data-whatever="'.$office.'" type="button" class="btn btn-outline-primary block" data-bs-toggle="modal"
    ...
    $subarray[] = "<a target='_blank' href='view-ledger?emp_id=".$employeeno."'><span class='bg-info p-1 text-white'>View Ledger</span></a>";
