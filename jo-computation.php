 ...
 include('db.php');
    ...
    //                               AND isactive='yes' LIMIT 10 ");
       ...
       $query = mysqli_query($db, "SELECT DISTINCT Assigned_dept_code FROM employment_info                     
                                    WHERE employmenttype='JO'  AND Assigned_dept_code!='0000012' AND Assigned_dept_code!='8859-600' AND 
                                  Assigned_dept_code!='0000001' AND Assigned_dept_code!='8859-300' AND Assigned_dept_code!='8859-500' AND Assigned_dept_code!='1021' AND Assigned_dept_code!=' 0000005'
                                  AND isactive='yes' ");
      $num = 0;
      $total = 0;
      $max_days = 26;
